...
def compile(build_dir, target_dir, option):
    ...
    if os.path.exists('creature.js'):
        os.remove('creature.js')
...
shutil.copy('build_wasm/creature.js', 'Release/creature.js')
shutil.copy('build_wasm/creature.wasm', 'Release/creature.wasm')